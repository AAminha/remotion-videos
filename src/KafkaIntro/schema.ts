...
export const kafkaIntroSchema = z.object({
  title: z.string(),
...
export type KafkaIntroProps = z.infer<typeof kafkaIntroSchema>;

export const calculateKafkaIntroMetadata: CalculateMetadataFunction<
  KafkaIntroProps
> = ({ props }) => {
